...
const HomeScreen: React.FC<Pick<MainScreenProps, 'trackingStatus' | 'todaysShopTime' | 'todaysTripTime' | 'currentSessionStartTime' | 'hourlyRate' | 'shopLocationSet' | 'endDay' | 'todaysSessions' | 'forceLocationCheck' | 'isRefreshingLocation' | 'locationError'>> = ({ 
    ...
    return (
        <div className="flex flex-col space-y-6">
            ...
            {shopLocationSet && (
                 <button
                    onClick={forceLocationCheck}
                    disabled={isRefreshingLocation}
                    className="fixed bottom-20 right-6 bg-blue-600 text-white rounded-full p-4 shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-transform duration-150 ease-in-out active:scale-95 disabled:bg-blue-300 disabled:cursor-not-allowed z-40"
